...
class UNetModel(nn.Module):
    ...
    def forward(self, x, t, y=None, return_sigma=False, **kwargs):
        """
        ...
        """
        if self.num_classes is not None:
            y = th.tensor([0], device=x.device, dtype=th.long)
            y = y.repeat(x.size(0))
    ...
    def local_encoder_pullback_xt(
            self, x=None, t=None, op=None, block_idx=None, pca_rank=16, chunk_size=10,
